<?php
	...
	$result_usuario = "SELECT * FROM vendedores WHERE id = '$id' LIMIT 1";
...
<div class="container theme-showcase" role="main">
	...
	<form class="form-horizontal" method="POST" action="administrativo/processa/edita/adm_proc_edita_advogados.php" enctype="multipart/form-data">
		<div class="form-group">
			<label class="col-sm-2 control-label">Nome</label>
			<div class="col-sm-10">
				<input type="text" name="nome" required class="form-control" id="inputEmail3" placeholder="Nome Completo" value="<?php echo $row_usuario['nome']; ?>">
			</div>
		</div>
		...
		<div class="form-group">
			...
			<div class="col-sm-10">
				<input type="email" name="email" required class="form-control" id="inputEmail3" placeholder="E-mail" value="<?php echo $row_usuario['email']; ?>">
			</div>
		</div>
		...
		<div class="form-group">
			...
			<div class="col-sm-10">
				<input type="password" name="senha" required class="form-control" id="inputPassword3" placeholder="Senha" value="<?php echo $row_usuario['senha_real']; ?>">
			</div>
		</div>	
		
		<div class="form-group">
			<label class="col-sm-2 control-label">Número de WhatsApp</label>
			<div class="col-sm-10">
				<input type="text" name="whatsapp" required class="form-control" id="inputEmail3" placeholder="Número de WhatsApp" value="<?php echo $row_usuario['whatsapp']; ?>">
			</div>
		</div>
